...
import {
  getDemandasPorObra,
} from "@/features/execucao-obras/demandas/services/demandas-service";

import {
  DemandaList,
} from "@/features/execucao-obras/demandas/components/demanda-list";

import ModalEditarDemanda from "@/features/execucao-obras/demandas/components/modal-editar-demanda";
      ...
      <div className="space-y-4 rounded-2xl border border-red-200 bg-red-50 p-8">
        <div>
          ...
          <p className="mt-1 text-sm text-red-700">
            Não foi possível buscar as demandas desta execução.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Gerenciamento das atividades da execução da obra
            </p>
          </div>
